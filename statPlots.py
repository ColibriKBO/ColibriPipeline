...
fig, (ax1, ax2) = plt.subplots(2, 1, sharex = True, figsize = (16,4), gridspec_kw=dict(hspace = 0.05))
...
plt.savefig('./meanTests/' + night + '_bias_stats_' + scope + '.png',bbox_inches = "tight")
plt.show()
plt.close()
#%%
