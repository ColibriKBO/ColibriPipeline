...
if __name__ == '__main__':
   ...
   #     date = sys.argv[1]   #night directory
	...
	for minute in minutedirs:
		...
		biasFileList=images
		pairs=0 #number of pairs that will be iterated
		ReadNoise=[] 
		...
		if len(biasFileList)% 2 == 0: #check for even or odd number of images in the directory
			...
			for i in range(0,len(biasFileList),2): #iterate through all pairs of subsequent bias images without dublicates
